function Footer() {
    return(
        <footer className="">
            <div className="">
                <div className="">
                <a href="/ecosystem" className="">Ecosystem</a>
                <a href="/community" className="">Community</a>
                <a href="/governance" className="">Governance</a>
                <a href="/developers" className="">Developers</a>
                <a href="https://blog.uniswap.org" className="">Blog</a>
                <a href="/faq" className="">FAQ</a>
                <a href="/privacy-policy" className="">Privacy Policy</a>
                <a href="/trademark" className="">Trademark Policy</a>
                <a href="/security" className="">Security</a>
                </div>
                <div className="">Media inquires for Uniswap Labs - Contact <a target="_blank" rel="noopener noreferrer" href="mailto:media@uniswap.org" className="">media@uniswap.org</a>
                </div>
            </div>
            <div className="">
                <a href="https://discord.gg/FCfyBSbCU5" target="_blank" rel="noopener noreferrer">
                <svg className="h-6" viewBox="0 0 71 55" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="h-6" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
