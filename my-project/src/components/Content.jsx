...
function Content() {
    return(
        <main className="bg-[#191b1f] bg-cover h-full">
            {/* <img src={bgStars} alt="bg-stars" className="w-full m-0"/> */}
            {/* sample */}

            {/* <div className="relative bg-cover bg-center h-screen" style={{ backgroundImage: `url(${bgStars})` }}>
                <div className="absolute inset-0 flex flex-col items-start justify-end">
                    ...
                    <p className="font-light max-w-[780px] text-2xl text-white">
            ...
            {/* sample */}
            <div className="bg-[#191b1f] bg-cover h-screen w-screen px-4 py-4 mx-auto flex justify-center">
                    {/* first section */}
            ...
            <div>
						<div>
							<div className="flex-col">
								<div className="flex w-full justify-between items-center m-0 text-white">
									<div>
